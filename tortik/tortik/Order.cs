        ...
        public void ChoosePoint(ref int PointerPosition)
        {
            ...
            while (true)
            {
                ...
                if (keyInfo.Key == ConsoleKey.Tab)
                {
                    ...
                    if (flag == true)
                    {
                        string path = @"C:\Users\dmitr\Desktop\TORTIK\zakaz.txt";
                        if (!File.Exists(@"C:\Users\dmitr\Desktop\TORTIK\zakaz.txt"))// создает вывод программы в исходную папку программы 
                        {
                            File.Create(path);
                        }
